...
class Config(metaclass=Singleton):
    ...
    def __init__(self, config_file: str = None):
        ...
        self.pgsql_database = os.getenv("PGSQL_DATABASE", "postgres")
        self.pgsql_password = os.getenv("PGSQL_PASSWORD")
        self.pgsql_host = os.getenv("PGSQL_HOST", "localhost")
        self.pgsql_user = os.getenv("PGSQL_USER", "root")
        self.pgsql_port = int(os.getenv("PGSQL_PORT", "5432"))
